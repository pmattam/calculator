...
let Buttons = ({ handleClick }) =>
  <div className='buttons'>
    <div className='row1'>
      ...
      <button className='div' value='/' onClick={handleClick}>/</button>
    </div>
    <div className='row2'>
      ...
      <button className='mul' value='*' onClick={handleClick}>x</button>
    </div>
    <div className='row3'>
      ...
      <button className='sub' value='-' onClick={handleClick}>-</button>
    </div>
    <div className='row4'>
